Workshop, previously called fhwr-unflattener, serves the Firefox Hardware Report
dataset in the format that [ensemble-transposer](https://github.com/mozilla/ensemble-transposer)
expects.
